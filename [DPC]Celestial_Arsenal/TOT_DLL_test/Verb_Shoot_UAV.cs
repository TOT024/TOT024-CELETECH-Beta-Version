...
namespace TOT_DLL_test
{
    public class Verb_Shoot_UAV : Verb_Shoot
    {
        ...
        {
            if(this.CompFloatingGunRework == null)
            {
                return false;
            }
            ...
            ShootLine shootLine;
            bool flag = base.TryFindShootLineFromTo(CompFloatingGunRework.currentPosition.ToIntVec3(), this.currentTarget, out shootLine, false);
            ...
            Vector3 drawPos = CompFloatingGunRework.currentPosition;
            ...
            if (this.verbProps.ForcedMissRadius > 0.5f)
            {
                ...
                float num2 = VerbUtility.CalculateAdjustedForcedMiss(num, this.currentTarget.Cell - CompFloatingGunRework.currentPosition.ToIntVec3());
                if (num2 > 0.5f)
                {
